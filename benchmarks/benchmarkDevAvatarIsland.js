...
testScript.addTest({
    ...
    traceActions: TestScript.locationSteps([
        ...
        {dt:6, pos:{x:12.5, y:-8.1, z: -8.9}, ori:{yaw: -58.3}},
        {dt:6, pos:{x:17.8, y:-8.1, z:-10.1}, ori:{yaw: -89.6}},
        {dt:6, pos:{x:22.5, y:-4.7, z: -5.4}, ori:{yaw:  60.9}},
        {dt:6, pos:{x: 9.8, y:-8.3, z: -4.9}, ori:{yaw:112.6 }},
        {dt:6, pos:{x:63.5, y:-2.1, z: 11.2}, ori:{yaw: 72.9 }}        
   ]),
    duration: 36
});

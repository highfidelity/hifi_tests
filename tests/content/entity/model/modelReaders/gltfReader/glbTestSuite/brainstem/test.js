...
nitpick.perform("Read GLTF model", Script.resolvePath("."), "secondary", [["high.win.amd", "tier.os.gpu"], ["high.win.nvidia", "tier.os.gpu"], ["mid.mac.amd", "tier.os.gpu"], ["low.intel", "tier.os.gpu"], ["", "tier.os.gpu"]], function(testType) {

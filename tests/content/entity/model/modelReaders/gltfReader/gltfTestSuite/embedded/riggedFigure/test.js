...
nitpick.perform("Read GLTF model", Script.resolvePath("."), "secondary", function(testType) {
    ...
    var testEntity = Entities.addEntity({
        ...
        modelURL: 'https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Models/master/2.0/RiggedFigure/glTF-Embedded/RiggedFigure.gltf',
        position: Vec3.sum(position, {x: 0.0, y: 0.0, z: -3.4 }),
    ...
    nitpick.addStepSnapshot("RiggedFigure.gltf Model is visible");

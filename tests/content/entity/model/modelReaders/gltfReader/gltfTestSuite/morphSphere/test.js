...
nitpick.perform("Read GLTF model", Script.resolvePath("."), "secondary", function(testType) {
    ...
    var testEntity = Entities.addEntity({
        ...
        modelURL: 'https://github.com/KhronosGroup/glTF-Sample-Models/blob/master/2.0/AnimatedMorphSphere/glTF/AnimatedMorphSphere.gltf',
    ...
    nitpick.addStepSnapshot("AnimatedMorphSphere.gltf Model is visible");

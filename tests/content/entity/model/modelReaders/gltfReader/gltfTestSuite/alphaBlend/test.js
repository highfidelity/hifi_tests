...
nitpick.perform("Read GLTF model", Script.resolvePath("."), "secondary", undefined, function(testType) {
    ...
    var testEntity = Entities.addEntity({
        ...
        modelURL: 'https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Models/master/2.0/AlphaBlendModeTest/glTF/AlphaBlendModeTest.gltf',
        position: Vec3.sum(position, {x: 0.0, y: 0.75, z: -6.5 }),
    ...
    nitpick.addStepSnapshot("AlphaBlendModeTest.gltf Model is visible");

...
nitpick.perform("Read GLTF model", Script.resolvePath("."), "secondary", function(testType) {
    ...
    var testEntity = Entities.addEntity({
        ...
        modelURL: 'https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Models/master/2.0/BarramundiFish/glTF/BarramundiFish.gltf',
        position: Vec3.sum(position, {x: 0.0, y: 0.75, z: -2.8 }),
        dimensions: { x: 0.5, y: 1.0, z: 2.0 },
        rotation: Quat.fromPitchYawRollDegrees(0.0, -60.0, 0.0),
        visible: true,
    ...
    nitpick.addStepSnapshot("BarramundiFish.gltf Model is visible");

...
nitpick.perform("Read GLTF model", Script.resolvePath("."), "secondary", function(testType) {
    ...
    var testEntity = Entities.addEntity({
        ...
        modelURL: 'https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Models/master/2.0/TextureCoordinateTest/glTF/TextureCoordinateTest.gltf',
        position: Vec3.sum(position, {x: 0.0, y: 0.75, z: -4.5 }),
    ...
    nitpick.addStepSnapshot("TextureCoordinateTest.gltf Model is visible");

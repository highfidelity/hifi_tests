...
autoTester.perform("TAA Anti-aliasing test", Script.resolvePath("."), "secondary", function(testType) {
    ...
    var wasTaa = !Render.getConfig("RenderMainView.Antialiasing").fxaaOnOff;
    ...
    autoTester.addStep("Set up test case", function () {
        ...
        // Turn on TAA on secondary and main view
        Render.getConfig("SecondaryCameraJob.AntialiasingSetup").play();
        Render.getConfig("SecondaryCameraJob.Antialiasing").fxaaOnOff = false;
    ...
    autoTester.addStep("Clean up after test", function () {
        ...
        Render.getConfig("RenderMainView.Antialiasing").fxaaOnOff = wasTaa;
        if (wasFxaa) {

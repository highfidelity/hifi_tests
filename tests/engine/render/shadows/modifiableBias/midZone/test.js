...
nitpick.perform("Modifiable Shadow - mid-sized zone", Script.resolvePath("."), "secondary", function(testType) {
    ...
    nitpick.addStep("Change position", function () {
      var offset = { x: 0.0, y: 5.0, z: zoneSize / 2.0 };
    ...
    nitpick.addStep("Change position", function () {
      var offset = { x: 0.0, y: 2.0, z: 15.0 };
      MyAvatar.position = Vec3.sum(MyAvatar.position, offset);
      validationCamera_translate(offset);
    });
    nitpick.addStep("Change position", function () {
      var offset = { x: 0.0, y: 0.0, z: 4.0 };
      MyAvatar.position = Vec3.sum(MyAvatar.position, offset);
      validationCamera_translate(offset);
    });
    nitpick.addStep("Change position", function () {

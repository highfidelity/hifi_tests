...
autoTester.perform("Texture Rendering", Script.resolvePath("."), "secondary", function(testType) {
    ...
    autoTester.addStep("Position avatar and camera", function() {
        MyAvatar.position = Vec3.sum(MyAvatar.position, Vec3.multiplyQbyV(MyAvatar.orientation, { x: 0, y: 0.4, z: 0.2 }));
        validationCamera_translate(Vec3.multiplyQbyV(MyAvatar.orientation, { x: 0, y: -0.2, z: 0.2 }));
    });

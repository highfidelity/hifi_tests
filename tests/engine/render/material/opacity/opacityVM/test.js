...
nitpick.perform("Show opacity value and mask map model", Script.resolvePath("."), "secondary", undefined, function(testType) {   
    ...
    var TEST_CASES = [ 
        {name:"hifi_opacityVM_albedoV",  a:-1.5, b:-0.5, c:0},
        {name:"hifi_opacityVM_albedoM",  a:-1.5, b:0.5, c:0},
    ];

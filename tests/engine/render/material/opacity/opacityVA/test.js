...
nitpick.perform("Show opacity value and blend map model", Script.resolvePath("."), "secondary", undefined, function(testType) {   
    ...
    var TEST_CASES = [ 
        {name:"hifi_opacityVA_albedoV",  a:-1.5, b:-0.5, c:0},
        {name:"hifi_opacityVA_albedoM",  a:-1.5, b:0.5, c:0},
    ];

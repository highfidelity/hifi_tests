...
nitpick.perform("Show effects of roughnessV25", Script.resolvePath("."), "secondary", undefined, function(testType) {
    ...
    var TEST_CASES = [
        {name:"hifi_roughnessV25_albedoV_ao",  a:-1.5, b:-0.5, c:0},
        {name:"hifi_roughnessV25_metallicV_albedoV_ao",  a:-1.5, b:0.5, c:0}, 
    ];

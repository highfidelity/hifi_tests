...
autoTester.perform("Show effects of roughness", Script.resolvePath("."), "secondary", function(testType) {
    ...
    var TEST_CASES = [
        {name:"hifi_roughnessV00_albedoV_ao",            a:-0.6, b: -2.0, c: -0.5},
        {name:"hifi_roughnessV25_albedoV_ao",            a:-0.6, b: -1.0, c: -0.5},
        {name:"hifi_roughnessV50_albedoV_ao",            a:-0.6, b:  0.0, c: -0.5},
        {name:"hifi_roughnessV75_albedoV_ao",            a:-0.6, b:  1.0, c: -0.5},
        {name:"hifi_roughnessV100_albedoV_ao",           a:-0.6, b:  2.0, c: -0.5},

        {name:"hifi_roughnessV00_metallicV_albedoV_ao",  a:-0.6, b: -2.0, c:  0.5},
        {name:"hifi_roughnessV25_metallicV_albedoV_ao",  a:-0.6, b: -1.0, c:  0.5},
        {name:"hifi_roughnessV50_metallicV_albedoV_ao",  a:-0.6, b:  0.0, c:  0.5},
        {name:"hifi_roughnessV75_metallicV_albedoV_ao",  a:-0.6, b:  1.0, c:  0.5},

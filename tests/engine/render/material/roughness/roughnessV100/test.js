...
nitpick.perform("Show effects of roughnessV100", Script.resolvePath("."), "secondary", undefined, function(testType) {
    ...
    var TEST_CASES = [
        {name:"hifi_roughnessV100_albedoV_ao",  a:-1.5, b:-0.5, c:0},
        {name:"hifi_roughnessV100_metallicV_albedoV_ao",  a:-1.5, b:0.5, c:0}, 
    ];

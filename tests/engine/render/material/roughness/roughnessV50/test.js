...
nitpick.perform("Show effects of roughnessV50", Script.resolvePath("."), "secondary", undefined, function(testType) {
    ...
    var TEST_CASES = [
        {name:"hifi_roughnessV50_albedoV_ao",  a:-1.5, b:-0.5, c:0},
        {name:"hifi_roughnessV50_metallicV_albedoV_ao",  a:-1.5, b:0.5, c:0}, 
    ];

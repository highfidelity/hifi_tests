...
nitpick.perform("Delete protocol sanity - TEST REQUIRES SERVER", Script.resolvePath("."), "secondary", undefined, function(testType) {
    ...
    nitpick.addStep("Verify DOMAIN childEntity1", function () {
    ...
    nitpick.addStep("Create AVATAR childEntity2 of 3", function () {
    ...
    nitpick.addStep("Verify AVATAR childEntity2", function () {
        var getProperties = Entities.getEntityProperties(childEntity2);
        saveResults(compareObjects(childEntityProperties, getProperties));
    });

    nitpick.addStep("Create DOMAIN childEntity3 of 3", function () {
    ...
    nitpick.addStep("Delete DOMAIN childEntity1 --> AVATAR childEntity2 should be deleted, but not DOMAIN childEntity3", function () {
        Entities.deleteEntity(childEntity1);
    });

    nitpick.addStep("Verify only DOMAIN childEntity1 and AVATAR childEntity2 are deleted", function () {
        var failures = [];
        ...
        console.warn(line, "DOMAIN childEntity1 deleted", !childEntity1Exists ? "pass" : "fail");
        ...
        console.warn(line, "AVATAR childEntity2 deleted", !childEntity2Exists ? "pass" : "fail");
        ...
        console.warn(line, "DOMAIN childEntity3 not deleted", childEntity3Exists ? "pass" : "fail");

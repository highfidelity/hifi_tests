...
%INSTALL_DIR%\interface.exe --url hifi://localhost/8000,8000,8000/0,0.0,0.0,1.0 --testScript https://raw.githubusercontent.com/highfidelity/hifi_tests/master/tests/performance/dev-avatarisland/testAuto.js quitWhenFinished --testResultsLocation %TEST_RESULT_LOCATION%
